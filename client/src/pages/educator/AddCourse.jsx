...
const AddCourse = () => {
  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full texy-gray-500'>
        ...
        <div>
          ...
          {showPopup && (
            <div className='fixed inset-0 flex items-center justify-center bg-[rgba(31,41,55,0.5)] z-50'>
