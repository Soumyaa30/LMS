...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 left-0 w-full h-85 bg-gradient-to-b from-[#7BB1D8]/80'></div>
      
      {/* left column */}
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='font-semibold text-gray-800 text-3xl'>{courseData.courseTitle}</h1>
        ...
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>Soumya Walia</span></p>
          ...
          <div className='pt-5'>
            {courseData.courseContent.map((chapter, index)=> (
              <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                ...
                <div className={`overflow-hidden transition-all duration-300 ${openSections[index] ? 'max-h-90' : 'max-h-0'}`}>
                  <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t boredr-gray-300'>
      ...
      {/* right column */}
      <div className='max-w-sm z-10 rounded-t md:rounded-none overflow-hidden min-w-[300px] sm:min-w-[420 px]'>
        ...
        <div className='pt-5'>
          ...
          <button className='md:mt-6 mt-4 w-full py-3 rounded bg-[#7A2048]/90 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>

          <div className='pt-6'>
          <p className='md:text-xl text-lg font-medium text-gray-800'>What's in this course?</p>
          <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
            <li>Comprehensive Learning Modules</li>
