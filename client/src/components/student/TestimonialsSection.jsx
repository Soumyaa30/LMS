...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Don't just take our word for it- read what our users have to say!</p>
      <div className='grid grid-cols-3 px-50 md:my-16 my-10 gap-8 mt-14'>
